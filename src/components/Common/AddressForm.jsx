...
const AddressForm = ({ form, onAddressChange, useExistingAddress = true, initialAddress = null, showUserInfo = false }) => {
  ...
  return (
      <>
        ...
        {/* Chỉ hiện thị khi người dùng đang nhập địa chỉ mới và chưa có địa chỉ mặc định */}
        {/* {_showUserInfo && !hasDefaultAddress() && (
          <Form.Item name="saveAsDefault">
            <Checkbox 
  ...
  >
    ...
    >
      <Alert
        message="Lưu ý"
        description="Địa chỉ mặc định sẽ sử dụng thông tin tên và số điện thoại từ tài khoản của bạn."
        type="info"
        showIcon
