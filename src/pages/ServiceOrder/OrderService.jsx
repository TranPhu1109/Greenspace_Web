...
const OrderService = () => {
  ...
  useEffect(() => {
    if (selectedCategory && allProducts.length > 0) {
      ...
      console.log(
        "Filtering products by all existing categories:",
        existingCategories
      );
  ...
  const handleConfirmOrder = async () => {
    try {
      ...
      console.log(
        "Sending order with latest products:",
                      ...
                      <div style={{ margin: "20px 0" }}>
                        ...
                        {!isAddressValid && (
                          ...
                          >
                            Vui lòng{" "}
                            {hasExistingAddress
                              ? "chọn địa chỉ có sẵn hoặc điền đầy đủ thông tin địa chỉ mới"
                              : "điền đầy đủ thông tin địa chỉ"}
                          </Text>
                        )}
                      </div>
